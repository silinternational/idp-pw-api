...
class AuthCest extends BaseCest
{
    ...
    {
        $I->wantTo('check response when making a GET request for logging in with client_id and correct access-token');
        $I->stopFollowingRedirects();
    ...
    {
        $I->wantTo('check response when making a POST request for logging in with client_id and correct access-token');
        $I->stopFollowingRedirects();
        $I->haveHttpHeader('Authorization', 'Bearer user1');
    ...
    {
        $I->wantTo('check response when making a PUT request for logging in with client_id and correct access-token');
        $I->stopFollowingRedirects();
        $I->haveHttpHeader('Authorization', 'Bearer user1');
    ...
    {
        $I->wantTo('check response when making a DELETE request for logging in with client_id and correct access-token');
        $I->stopFollowingRedirects();
        $I->haveHttpHeader('Authorization', 'Bearer user1');
    ...
    {
        $I->wantTo('check response when making a OPTIONS request for logging in with client_id and correct access-token');
        $I->stopFollowingRedirects();
        $I->haveHttpHeader('Authorization', 'Bearer user1');
